...
add_fileset_file LCD.vhd VHDL PATH LCD.vhd TOP_LEVEL_FILE
...
add_interface_port conduit_end Data data Output 16
add_interface_port conduit_end DCX dcx Output 1
add_interface_port conduit_end WRX wrx Output 1
add_interface_port conduit_end LEDS leds Output 32
add_interface_port conduit_end RDX rdx Output 1
